...
# Load both airports and flights from the respective files
...
# Return an Airport object based on its code, or raise an error
...
# Return all flights where the city matches origin or destination
...
# Return all flights where the country matches origin or destination
...
# Check if a direct flight exists from origin to destination
...
# Return the shortest flight from a given airport
...
# Return the flight going back to the original departure airport
...
# Read and validate all maintenance records from a file
